...
public class BaseAndroidTestCase {
  ...
  protected Note categorizeNote(Note note, Category category) {
  ...
  protected int getCategorizedCountByCategory(Category category) {
    return dbHelper.getCategorizedCount(category);
  }
